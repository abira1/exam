            ...
            return (
              <div className="bg-gradient-to-br from-blue-500 to-indigo-600 rounded-lg shadow-lg p-8 mb-6 text-white">
                <div className="text-center">
                  ...
                  {/* Raw Score Display */}
                  <div className="mb-6">
                    <p className="text-blue-100 text-sm mb-2 uppercase tracking-wider">Raw Score</p>
                    <div className="text-6xl font-bold mb-2">
                      {correctAnswers}<span className="text-3xl text-blue-200">/{totalQuestions}</span>
                    </div>
                  ...
                  {bandScore !== null && (
                    <div className="border-t-2 border-blue-400 pt-6">
                      <p className="text-blue-100 text-sm mb-2 uppercase tracking-wider">IELTS Band Score</p>
                  ...
                  {/* Percentage Display - For non-Listening/Reading tests */}
                  {bandScore === null && (
                    <div className="border-t-2 border-blue-400 pt-6">
                      <p className="text-blue-100 text-sm mb-2 uppercase tracking-wider">Percentage</p>
                      <div className="text-7xl font-bold mb-2">
